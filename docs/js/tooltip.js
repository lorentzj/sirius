function updateToolTip(tooltipElem, token) {
...
export function setHandler(tooltipElem, tokenElem, tokenId, ast) {
...
function getIdentType(tokenId, ast) {
...
function getIdentTypeInBlock(tokenId, statements) {
...
function getIdentTypeInExpr(tokenId, expression) {

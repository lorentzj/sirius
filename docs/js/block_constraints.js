function setMouseOverHLHandler(blockConstraintsElem, editorElem, blockInfoElem, blockId, blockFirstTokenId) {
...
function createConstraintLineDiv(blockConstraintsELem, editorElem, lineBlocks) {
...
function statementAtLine(statements, tokens, line) {
...
function constraintLevels(parseOutput) {
    let functionLines = [];
